...
#ifndef FINDIK_FILTER_URL_PCRE_REQUEST_FILTER_HPP
#define FINDIK_FILTER_URL_PCRE_REQUEST_FILTER_HPP
...
/*!
 ...
 @author Burak Oguz
*/
		class url_pcre_request_filter :
			public abstract_request_filter, public boost::enable_shared_from_this<url_pcre_request_filter>
		{
		public:
			~url_pcre_request_filter(void);
			/*!
                        Implementing function of  abstract_request_filter::filter(). Gets url name from request header and checks it from
                        pcre objects. 

                        \return true if url does not exists in blacklist pcre database
                        */
			bool filter();
			...
			/*!
                        ...
                        \return an instance of url_pcre_request_filter
                        */
		...
		private:
			/*!
                        ...
                        \param manager database manager object to filter searching (not used by this class)
                        \param request request object which filtering operation will use
                        */
			url_pcre_request_filter(persistency::dbmanager::pointer & manager, io::request & request);
