...
#ifndef FINDIK_PROTOCOLS_HTTP_GOOGLE_SAFE_SEARCH_FILTER_HPP
#define FINDIK_PROTOCOLS_HTTP_GOOGLE_SAFE_SEARCH_FILTER_HPP
...
namespace findik
{
	namespace protocols
	{
		namespace http
		{
			...
			/*!
                        Google safe search filter for HTTP protocol.
                        ...
                        */
			class google_ss_filter:
				public boost::enable_shared_from_this<google_ss_filter>,
			...
			typedef boost::shared_ptr<google_ss_filter> google_ss_filter_ptr;
